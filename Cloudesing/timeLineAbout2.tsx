...
export default function JourneyTimeline() {
  ...
  return (
    <section className="bg-[#0A0A0A] py-10 md:py-[103px] overflow-hidden font-sans">
      ...
      <div className="relative  h-[410px] md:h-[500px]  overflow-hidden">
        <div
          ref={scrollContainerRef}
          className="overflow-x-auto overflow-y-hidden scrollbar-hide h-full cursor-grab active:cursor-grabbing"
        >
          <div className="relative inline-flex items-center h-full">
            {[1, 2, 3].map((copy) => (
              <div
                key={copy}
                className="relative inline-flex items-start h-full pt-[1.7%] flex-shrink-0"
                style={{ minWidth: `${singleTimelineWidth}px` }}
              >
                <div className="absolute w-full h-[2px] bg-white/10 top-[28.4%] md:top-[33%] -translate-y-1/2" />
                  ...
                  {timelineEvents.map((event, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Event Card */}
                        <div
                          className={`absolute top-[20px] md:top-[40px] 
                            left-4 md:left-8 w-[280px] md:w-[393px] h-[266px] bg-gradient-to-b from-[rgba(35,35,35,0)] to-[#232323] rounded-xl p-3 md:p-4 border shadow-2xl transition-all duration-200 overflow-hidden flex flex-col ${
                              isActive
                                ? "border-red-600/50"
                                : "border-[#353535]"
                            }`}
                        >
                          ...
                          <div className="mb-2 md:mb-3 flex-shrink-0">
                            <div className="w-[48px] h-[48px] md:w-[56px] md:h-[56px] pt-[10px] pr-[9px] pb-[9px] pl-[10px] md:pt-[12px] md:pr-[11px] md:pb-[11px] md:pl-[12px] bg-gradient-to-b from-[rgba(35,35,35,0)] to-[#232323] border border-[#353435] rounded-[8px] md:rounded-[10px] flex items-center justify-center">
                              <Image
                                src={event.icon}
                                alt="icon"
                                width={48}
                          ...
                          <p className="text-gray-400 text-sm md:text-base leading-relaxed mb-2 md:mb-3 font-inter flex-shrink-0">
                            {event.description}
                          </p>

                          {/* Logos Row */}
                          {event.logos && (
                            <div className="flex flex-wrap gap-2 md:gap-3 items-center flex-shrink-0">
                          ...
                          {event.highlight && (
                            <div className="space-y-2 md:space-y-2 flex-shrink-0">
                              <div className="bg-[#153B23] w-full border border-[#22C55E]/20 rounded-lg px-3 py-1.5 md:px-3 md:py-1.5">
                                <p className="text-[#22C55E] font-bold text-sm md:text-base tracking-wide font-inter">
                                  {event.highlight}
                                </p>
                              </div>
